...
(
    ...
    final_status_customer     SMALLINT      NULL
        CONSTRAINT job_offer_final_status_check
            CHECK (final_status_customer >= 0 AND final_status_customer <= 2),
    final_status_professional SMALLINT      NULL
        CONSTRAINT job_offer_final_status_professional_check
            CHECK (final_status_professional >= 0 AND final_status_professional <= 2)
);
...
INSERT INTO public.job_offer(id, final_status_customer) VALUES (1,0),(2,1),(3,2);
INSERT INTO public.customers_job_offers VALUES ('1e19391c-134e-49cd-89cd-863bba1bf58f',1),('1e19391c-134e-49cd-89cd-863bba1bf58f',2),('1e19391c-134e-49cd-89cd-863bba1bf58f',3);
INSERT INTO public.job_offer(id, final_status_professional) VALUES (4,0),(5,1),(6,2);
INSERT INTO public.professionals_job_offers VALUES ('6189efed-3c1f-4f81-b838-04371721804f',4),('6189efed-3c1f-4f81-b838-04371721804f',5),('6189efed-3c1f-4f81-b838-04371721804f',6);