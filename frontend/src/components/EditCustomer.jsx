...
const EditCustomer = ({ xsrfToken, handleErrors }) => {
    ...
    //     setCustomer((prev) => {
    //         const updatedNotes = [...prev[fieldType]];
    //         updatedNotes[index] = { ...updatedNotes[index], state: "deleted" }; // Imposta lo stato come "deleted"
    //         return { ...prev, [fieldType]: updatedNotes };
    //     });
    // };
    ...
    const validateForm = async () => {
        ...
        console.log("formErrors", customer.emails.length , customer.telephones.length ,customer.addresses.length )
